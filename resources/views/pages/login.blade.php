    ...
    <!-- Validation Errors -->
        <form method="POST" action="{{ route('auth.login') }}">
            ...
            <div class="block mt-4">
                ...
                @if (isset($error))
                    <div class="text-red-600 flex items-center mt-4">
                        {{ $error }}
                    </div>
                @endif
            <div class="flex items-center justify-between mt-4">
                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="/signup">Signup</a>
                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="/forgot-password">Forgot your password?</a>
